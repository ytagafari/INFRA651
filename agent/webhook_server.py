...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_POST(self) -> None:  # noqa: N802
        ...
        self._json(200, {
            ...
            "credibility": result.credibility.to_dict() if result.credibility else None,
            "document_selection": result.selected_documents.to_dict() if result.selected_documents else None,
            "client_profile": result.client_profile.to_dict() if result.client_profile else None,
            "client_profile_path": result.profile_path,
            "matched_documents": [
                {
                    "doc_id": d.doc_id,
                    "title": d.title,
                ...
                for d in (result.selected_documents.documents if result.selected_documents else result.retrieval.documents)
            ],
